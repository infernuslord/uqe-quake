...
void Sbar_ShowScores (void)
{
	if (sb_showscores)
		return;
	sb_showscores = true;
	//sb_updates = 0; // jkrige - always draw sbar
}
...
void Sbar_IntermissionOverlay (void)
{
	...
	pic = Draw_CachePic ("gfx/complete.lmp");
	Draw_Pic (cx-94, cy - 96, pic);
	
	pic = Draw_CachePic ("gfx/inter.lmp");
	Draw_TransPic (cx-160, cy - 64, pic);
	// jkrige - centered intermission
...
// time
	...
	Sbar_IntermissionNumber (cx, cy - 56, dig, 3, 0);
	// jkrige - centered intermission
	...
	Draw_TransPic (cx+74, cy-56, sb_colon);
	Draw_TransPic (cx+86, cy-56, sb_nums[0][num/10]);
	Draw_TransPic (cx+106, cy-56, sb_nums[0][num%10]);
	
	Sbar_IntermissionNumber (cx, cy-16, cl.stats[STAT_SECRETS], 3, 0);
	Draw_TransPic (cx+72, cy-16, sb_slash);
	Sbar_IntermissionNumber (cx+80, cy-16, cl.stats[STAT_TOTALSECRETS], 3, 0);
	
	Sbar_IntermissionNumber (cx, cy+24, cl.stats[STAT_MONSTERS], 3, 0);
	Draw_TransPic (cx+72, cy+24, sb_slash);
	Sbar_IntermissionNumber (cx+80, cy+24, cl.stats[STAT_TOTALMONSTERS], 3, 0);
	// jkrige - centered intermission
}
